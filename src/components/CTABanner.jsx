        ...
        <div className="cta-inner">
          ...
          <div className="cta-content">
            ...
            <div className="cta-buttons">
              <a href="https://dashboard.blogy.in/signup" target="_blank" rel="noopener noreferrer" className="cta-btn-main">
                Start For Free
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
              </a>
              <a href="https://dashboard.blogy.in" target="_blank" rel="noopener noreferrer" className="cta-btn-ghost">
                See Live Demo
              </a>
            </div>
