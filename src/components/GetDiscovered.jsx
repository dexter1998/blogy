...
const SEARCH_ENGINES = [
  ...
  { name: 'Bing',           desc: "Microsoft's search engine",   slug: 'bing',             bg: '#2563eb' },
  { name: 'DuckDuckGo',     desc: 'Privacy-first search engine', slug: 'duckduckgo',       bg: '#ea580c' },
  { name: 'Yahoo Search',   desc: 'One of the oldest engines',   slug: 'yahoo',            bg: '#7c3aed' },
];
...
const AI_PLATFORMS = [
  ...
  { name: 'Gemini',     desc: "Google's AI model",          slug: 'googlegemini',         bg: '#2563eb' },
];
              ...
              <div key={i} className="gd-item">
                <div className="gd-item-icon" style={{ background: e.bg }}>
                  {e.src
                    ...
                    : <span className="gd-icon-letter" style={{ background: e.bg }}>
                        <img src={`${SI}/${e.slug}/white`} alt={e.name} width="14" height="14" loading="lazy" decoding="async" style={{ width: '14px', height: '14px', objectFit: 'contain' }} />
                      </span>}
                </div>
                <div>
              ...
              <div key={i} className="gd-item">
                <div className="gd-item-icon" style={{ background: p.bg }}>
                  {p.src
                    ...
                    : <span className="gd-icon-letter" style={{ background: p.bg }}>
